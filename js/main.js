...
const projects = [
  {
    ...
    desc: "Приложение для отслеживания кэшбэка за месяц в случае если у вас несколько карт одного или нескольких банков. Можно по поиску найти категорию которая нужна и увидеть на какой карте кэшбэк больше. Также в случае если на одной карте есть кэшбэк одной категории, он суммируется и отображается. </br> </br> Приложение меняет свою тему в зависимости от системной темы вашего устройства.",
    img: "img/11.png",
  ...
  },
  {
    ...
    desc: "Корпоративный сайт - интернет-магазин мукомольного комбината. На сайте можно ознакомиться с продукцией и также оставить заявку на покупку.",
    img: "img/3.png",
...
projects.forEach((project) => {
  ...
  descSpan.innerHTML = project.desc;
